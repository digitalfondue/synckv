...
public class GCTest {
    ...
    public void kvCleanupTest() {
        ...
        try (SyncKV kv = new SyncKV(null, null, null, null)) {
            ...
            Assert.assertEquals(1, table.dumpTable().size());
            ...
            Assert.assertEquals(1, table.count());
            Assert.assertEquals(2, table.dumpTable().size());
            ...
            Assert.assertEquals(1, table.count());
            Assert.assertEquals(3, table.dumpTable().size());
            ...
            Assert.assertEquals(4, table.dumpTable().size());
            Assert.assertEquals("test3", table.getAsString("test"));
